...
<div class="thirtheen columns content">
    ...
    <div class="four columns veiling">
        ...
        <a href="<?= SITE_URL ?>producten/<?= $aflopend->voorwerpnummer . '-' . trim( preg_replace( "/[^0-9a-z]+/i", "",str_replace(" ","-",strtolower($aflopend->titel)))) ?>" class="ganaarveilingbutton"><strong> BIED MEE</strong> </a>
